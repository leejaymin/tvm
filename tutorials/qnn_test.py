...
weight_scale = relay.const(np.array(0.3).astype("float32"))
bias_scale = relay.const(np.array(0.06).astype("float32"))
...
simple_net = relay.qnn.op.conv2d(data,
                                 ...
                                 kernel_scale=relay.const(0.3, "float32"),
                                 kernel_size=(3, 3),
                                 channels=4,
                                 padding=(1, 1),
                                 strides=(1, 1),
...
# simple_net = relay.qnn.op.dequantize(
#         simple_net,
#         input_scale=relay.const(0.006, "float32"),
#         input_zero_point=relay.const(0, "int32")
#         )
